...
const ServiceDetail = () => {
  ...
  useEffect(() => {
    axios(`${URL_API}api/v1/ambassadorship/usta-service-banner/`).then(
      ({ data }) => setBannerData(data[0])
    );
  ...
  return (
    <div className="service-detail">
      <div
        ...
        style={{
          backgroundImage: `url(${bannerData.banner_image})`,
        }}
      >
              ...
              dangerouslySetInnerHTML={{
                __html:
                  lang === "ru"
                    ...
                    : lang === "en"
                    ? bannerData.banner_description_en
                    : bannerData.banner_description_ky,
              }}
            ></p>
          </div>
        </div>
        ...
        <div className="container">
          <div className="service-detail-menu">
            {serviceList.map((item) => {
              return (
                <div className="service-detail-menu-item">
                  <div
